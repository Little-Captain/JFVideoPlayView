    ...
    if (isFull) { // 从非全屏切换到全屏
        ...
        [self.containerViewController presentViewController:self.fullVc animated:NO completion:^{
            ...
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(self.fullVc.view.mas_top);
                make.left.mas_equalTo(self.fullVc.view.mas_left);
                make.right.mas_equalTo(self.fullVc.view.mas_right);
        ...
        [self.fullVc dismissViewControllerAnimated:NO completion:^{
            ...
            [self mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(self.containerViewController.view.mas_top);
                make.left.equalTo(self.containerViewController.view.mas_left);
                make.right.equalTo(self.containerViewController.view.mas_right);
                make.height.equalTo(self.mas_width).multipliedBy(9.0 / 16.0);
            }];
            [self setNeedsLayout];
            [UIView animateWithDuration:0.15 delay:0.0 options:UIViewAnimationOptionLayoutSubviews animations:^{
